...
[rIACI](https://cran.r-project.org/package=rIACI) v1.0.0: Provides functions to calculate the Iberian Actuarial Climate Index and its components—including temperature, precipitation, wind power, and sea level data—to support climate change analysis and risk assessment. See ["Zhou et al." (2023)](https://revistas.actuarios.org/index.php/aiae/article/view/55) for further detail and the [vignette](https://cran.r-project.org/web/packages/rIACI/vignettes/introduction.html) to get started.
...
[RcensusPkg](https://cran.r-project.org/package=RcensusPkg) v0.1.5: Provides a structured way to access US Census Bureau survey and geographic data and return a data frame, and also includes functions to access and layer  displayable geometries states, counties, blocks/tracts, roads, landmarks, places, and bodies of water. See [README](https://cran.r-project.org/web/packages/RcensusPkg/readme/README.html) for an example.
...
[SerolyzeR](https://cran.r-project.org/package=SerolyzeR) v1.1.0: designed for inexperienced R uers the package facilitates the process of loading raw data from MBA (Multiplex Bead Assay) examinations, performs quality control checks, and automatically normalises the data, preparing it for more advanced, downstream tasks. See the [vignette](https://cran.r-project.org/web/packages/SerolyzeR/vignettes/example_script.html).
...
[clinify](https://cran.r-project.org/package=clinify) v 0.1.2: Builds on `flextable` and `officer` to simplify the formatting of clinical tables for reguatory use. See the [vignette](https://cran.r-project.org/web/packages/clinify/vignettes/clinify.html).
