...
[raptools](https://cran.r-project.org/package=raptools) v1.23.0: Provides tools for assessing the comparative performance of two logistic regression models or results of such models or classification models. Discrimination metrics include Integrated Discrimination Improvement, Net Reclassification Improvement,difference in Area Under the Curves, and Brier scores and Brier skill. Methods are described in [Pencina et al. (2008)](https://onlinelibrary.wiley.com/doi/10.1002/sim.2929). Look [here](https://researchverse.github.io/raptools/) for examples.
