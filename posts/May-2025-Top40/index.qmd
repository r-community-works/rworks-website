...
date: "2025-06-27"
description: "An attempt to capture the depth and breadth of what's new on CRAN.  Visualization." - One Hundred seventy-six new packages madde it to CRAN in May. Here are my Top 40 picks in eighteen categories: Climate Science, Computational Methods, Data, Decision Analysis, Ecology, Epidemiology, Finance, Machine Learning, Mathematics, Medicine, Networks,  Statistics, Phylogenetics, Programming, Time Series, Topological Data Analysis, Utilities, and Visualization.
image: "tabs.gif"
...
One Hundred seventy-six new packages madde it to CRAN in May. Here are my Top 40 picks in eighteen categories: Climate Science, Computational Methods, Data, Decision Analysis, Ecology, Epidemiology, Finance, Machine Learning, Mathematics, Medicine, Networks,  Statistics, Phylogenetics, Programming, Time Series, Topological Data Analysis, Utilities, and Visualization.
...
[bitfield](https://cran.r-project.org/package=bitfield) v0.6.1: Provides functions to capture the computational footprint of any model workflow or output by encoding computational decisions into sequences of bits or [bitfields](https://en.wikipedia.org/wiki/Bit_field) that are transformed to integer values. This allows storing information useful for documenting metadata, intermediate that accrue along a workflow, or output metrics. See [README](https://cran.r-project.org/web/packages/bitfield/readme/README.html).
