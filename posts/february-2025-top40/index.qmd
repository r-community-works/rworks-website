...
[matriz](https://cran.r-project.org/package=matriz) v1.0.1: Implements a workflow that provides tools to create, update and fill literature matrices commonly used in research, specifically epidemiology and health sciences research. See [README]
(https://cran.r-project.org/web/packages/matriz/readme/README.html) togetstarted.
...
[SimTOST](https://cran.r-project.org/package=SimTOST) v1.0.2: Implements a Monte Carlo simulation approach to estimating sample sizes, power, and type I errorrates for bio-equivalence trials that is based on the Two One-Sided Tests (TOST) procedure. Users can model complex trial scenarios, including parallel and crossover designs, intra-subject variability, and different equivalence margins. See [Schuirmann (1987)](https://link.springer.com/article/10.1007/BF01068419), [Mielke et al. (2018)](https://www.tandfonline.com/doi/full/10.1080/19466315.2017.1371071), and  [Shieh (2022)](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0269128) for background. There are seven vignettes including [Introduction]
(https://cran.r-project.org/web/packages/SimTOST/vignettes/intropkg.html) and [Bioequivalence Tests for Parallel Trial Designs: 2 Arms, 1 Endpoint](https://cran.r-project.org/web/packages/SimTOST/vignettes/sampleSize_parallel_2A1E.html).
...
[SPIChanges](https://cran.r-project.org/package=SPIChanges) v0.1.0: Provides methods to improve the interpretation of the Standardized Precipitation Index under changing climate conditions. It implments the nonstationary approach of [Blain et al. (2022)](https://rmets.onlinelibrary.wiley.com/doi/10.1002/joc.7550) to detect trends in rainfall quantities and to quantify the effect of such trends on the probability of a drought event occurring. There is an [Introduction](https://cran.r-project.org/web/packages/SPIChanges/vignettes/SPIChanges.html) and the vignetteon  [Monte Carlo Experiments and Case Studies](https://cran.r-project.org/web/packages/SPIChanges/vignettes/CaseStudies.html).
