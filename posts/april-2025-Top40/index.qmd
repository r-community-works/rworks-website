...
[connector](https://cran.r-project.org/package=connector) v0.1.1: Facilitates clinical research by providing a consistent interface for connecting to various data sources including file systems and databases including *ADAM* and *SDTM*. See the vignettes [connector](https://cran.r-project.org/web/packages/connector/vignettes/connector.html) and [How to extend connector](https://cran.r-project.org/web/packages/connector/vignettes/customize.html).
