...
[cheetahR](https://cran.r-project.org/package=cheetahR) v0.2.0: Provides an interface to [Cheetah Grid](https://github.com/future-architect/cheetah-grid), a high-performance JavaScript table widget. See [Get Started](https://cran.r-project.org/web/packages/cheetahR/vignettes/cheetahR.html).
