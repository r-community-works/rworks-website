...
Because users are more accustomed to using layers that have the ‘geom’ prefix, you might also define geom with identical properties via aliasing.[@cr-step-3b]
