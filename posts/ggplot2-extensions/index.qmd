...
date: 2025-06-12
editor: source
description: "Enter the exciting world of the ggextenders."
...
However, I was never a "ggextender" myself (having just used and never developed an extender).  found the idea of creating an extension daunting. That is, until recently!
...
Because users are more accustom to using layers that have the ‘geom’ prefix, you might also define geom with identical properties via aliasing.[@cr-step-3b]
...
Going through the recipes is a great way to easing into your ggplot2 extension journey. They offer three well-crafted examples with a clear structure and sequence of steps. A fun note is that the geom recipes website uses [webR](https://docs.r-wasm.org/webr/latest/) and [Quarto Live](https://github.com/r-wasm/quarto-live) to embed interactive code chunks directly in the tutorial. It makes for an immersive experience while going through the exercises.
...
It's a true delight going through Gina's resources, from seeing the [adorable ggextenders hex](https://evamaerey.github.io/everyday_ggplot2_extension/community.html) to reading all the touching notes about ggplot2, comparing it to art, food, poetry, and more. It's a true testament of how a tool can inspire so many. Here are some of my favorites quotations and metaphors:
