...
"Point" is specified as the default for the geom argument in the function. This means that the `ggplot2::geom_point()` will be used in the layer unless otherwise specified by the user.[@cr-step-3a]{highlight="3"}
...
Alternatively, the new `make_constructor()` function, available in ggplot2 v4.0.0, will write much of the above boilerplate code for you.[@cr-step-3a-1]{highlight="1"}
