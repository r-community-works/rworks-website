...
[pprof](https://cran.r-project.org/package=pprof) v1.0.1: Implements linear and generalized linear models for provider profiling, incorporating both fixed and random effects as well as post-modeling features, such as standardization measures, hypothesis testing, confidence intervals, and visualization. See [Wu et al. (2022)](https://onlinelibrary.wiley.com/doi/10.1002/sim.9387) ad [README](https://cran.r-project.org/web/packages/pprof/readme/README.html) for ore information.

### Health Technology Assessment

[tatooheene](https://cran.r-project.org/package=tatooheene) v0.19.0: Provides functions to support economic modelling in R based on the methods of the [Dutch guideline](ttps://www.zorginstituutnederland.nl/publicaties/publicatie/2024/01/16/richtlijn-voor-het-uitvoeren-van-economische-evaluaties-in-de-gezondheidszorg) for economic evaluations in healthcare, [CBS data](https://www.cbs.nl/), and [OECD data](https://www.oecd.org/en.html). See [README](https://cran.r-project.org/web/packages/tatooheene/readme/README.html).
